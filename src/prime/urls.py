...
from primeExchange.views import edit_drow1,edit_drow2,new_drow1,new_drow2,display,time
from primeExchange.views import download_to_excel
urlpatterns = [
    ...
    url(r'^time/$',time),
    url(r'^download_to_excel/$',download_to_excel)
