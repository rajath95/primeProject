...
urlpatterns = [
    ...
    url(r'^login/$',auth_views.login, {'template_name': 'primeExchange/login.html'},name="login"),
    url(r'^logout/$',auth_views.logout,{'template_name':'primeExchange/logout.html'},name="logout"),
